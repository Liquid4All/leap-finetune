...
from leap_finetune.distribution.backends.kuberay import (
...
def test_load_kubernetes_config_exits_after_both_config_loaders_fail():
    class FailingConfig:
        @staticmethod
    ...
    with pytest.raises(SystemExit):
        _load_kubernetes_config(FailingConfig)
