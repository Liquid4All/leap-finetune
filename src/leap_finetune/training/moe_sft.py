...
from leap_finetune.distribution.context_parallel import dist_barrier
...
from leap_finetune.training.utils.context_parallel import ContextParallelSFTMixin
...
def moe_sft_run(training_config: dict) -> None:
    ...
    if train_config.get("context_parallel_size", 1) > 1:
        trainer.cp_config = setup_context_parallel(
            trainer.model,
            train_config,
