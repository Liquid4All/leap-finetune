...
from leap_finetune.training.moe_utils.ops import route_tokens_to_experts
...
def switch_load_balancing_loss(
    ...
    if sequence_partition_group is not None:
        # CP ranks each hold a chunk of the same sequence and FSDP averages
        # gradients across ranks. Match the CP causal-LM scaling.
