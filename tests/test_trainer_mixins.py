...
class FailingTrainer:
    def __init__(self, *, global_step=0, max_steps=-1, epoch=None, num_train_epochs=1):
        ...
        self.args = SimpleNamespace(max_steps=max_steps, num_train_epochs=num_train_epochs)
...
def test_run_training_safely_suppresses_cleanup_error_after_epoch_target(caplog):
    trainer = FailingTrainer(global_step=10, max_steps=-1, epoch=1.0, num_train_epochs=1)
